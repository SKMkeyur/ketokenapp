...
import 'package:ketoken/screens/loginphoneverification.dart';
                    ...
                    children: [
                      InkWell(
                        onTap: (){
                          print("helo");
                          // PhoneNumberScreen();
                          if(validateTextField(registerController.text) && isphoneokay==true){
                            ...
                            child:   TextButton(
                              ...
                              onPressed: (){
                                ...
                                if(validateTextField(registerController.text) && isphoneokay==true){
                                  //   _loadCounter(registerController.text);
                                  Navigator.push(context, MaterialPageRoute(
                                      builder: (context) => LoginPhoneVerificationScreen())
                                  );
                                }else{
                                  Fluttertoast.showToast(
                                      msg: "Please enter remaining numbers",
