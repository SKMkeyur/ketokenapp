...
class LoginPhoneVerificationScreen extends StatefulWidget {
  const LoginPhoneVerificationScreen({Key? key}) : super(key: key);

  @override
  _LoginPhoneVerificationScreenState createState() => _LoginPhoneVerificationScreenState();
}

class _LoginPhoneVerificationScreenState extends State<LoginPhoneVerificationScreen> {
  late String code1="";
  late int num=0;
  @override
  void initState() {
