...
class CheckBalanceOtpScreen extends StatefulWidget {

   const CheckBalanceOtpScreen({Key? key}) : super(key: key);
  //
  ...
  //
  //
  // CheckBalanceOtpScreen(this.shortname, this.displayName, this.money);

  @override
  _CheckBalanceOtpScreenState createState() => _CheckBalanceOtpScreenState();
}

class _CheckBalanceOtpScreenState extends State<CheckBalanceOtpScreen> {
  late String code1="";
  late int num=0;
