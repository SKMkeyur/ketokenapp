...
class ChangePasswordOtpVerificationScreen extends StatefulWidget {
  const ChangePasswordOtpVerificationScreen({Key? key}) : super(key: key);

  @override
  _ChangePasswordOtpVerificationScreenState createState() => _ChangePasswordOtpVerificationScreenState();
}

class _ChangePasswordOtpVerificationScreenState extends State<ChangePasswordOtpVerificationScreen> {
  late String code1="";
  late int num=0;
