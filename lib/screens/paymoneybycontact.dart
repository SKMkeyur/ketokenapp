...
class PayMoneyByContactScreen extends StatefulWidget {
  // const PayMoneyByContactScreen({Key? key}) : super(key: key);

  late String name;
  late String shortName;
  late List<Contact> contacts1;

  PayMoneyByContactScreen(this.name, this.shortName, this.contacts1);

  @override
  _PayMoneyByContactScreenState createState() => _PayMoneyByContactScreenState();
}

class _PayMoneyByContactScreenState extends State<PayMoneyByContactScreen> {
                        ...
                        children: [
                          Container(
                            ...
                            Container(
                              ...
                              child: Text(widget.shortName,style: TextStyle(color: Colors.pink,fontSize: 24),),
                            ),
                  ...
                  onTap: (){
                    ...
                    if (_isPayAllow == true) {
                      ...
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context) => MoneyOtpVerificationScreen(widget.shortName,widget.name,_otp))
                      );
                    }else{
                      //  _showToast(context);
                  ...
                  child: Container(
                      ...
                      child:   TextButton(
                        ...
                        onPressed: (){
                          ...
                          // _handleSubmit();
                          // Navigator.push(context, MaterialPageRoute(
                          //     builder: (context) => MoneyOtpVerificationScreen())
                          // );
                          //print('hello');
                        },
                      )
