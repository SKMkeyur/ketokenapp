...
class Paint03 extends StatefulWidget {
  const Paint03({Key? key}) : super(key: key);

  @override
  _Paint03State createState() => _Paint03State();
}

class _Paint03State extends State<Paint03> {
  @override
